...
const VEGA_ADDRESS = "0xDEC79cE4b88709a6fBa920C9Ef8653A840612Ab0";
  ...
  return (
    <>
      ...
      <div className="vega-content">
        ...
        <hr />
        {renderPurchaseForm()}
        {errorMessage !== null ? <p className="error">Error: {errorMessage}</p> : successHash !== null ? <p className="success">Donation successful — <a target="_blank" href={"https://etherscan.io/tx/"+successHash}>view transaction</a></p> : <></>}
